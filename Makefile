...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kyma-companion-manager-builder
	$(CONTAINER_TOOL) buildx use kyma-companion-manager-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kyma-companion-manager-builder
	rm Dockerfile.cross
