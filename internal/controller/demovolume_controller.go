...
import (
	...
	demov1 "github.com/cloudsteak/kubebuilder/api/v1"
)
...
// +kubebuilder:rbac:groups=demo.demo.operator,resources=demovolumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=demo.demo.operator,resources=demovolumes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=demo.demo.operator,resources=demovolumes/finalizers,verbs=update
